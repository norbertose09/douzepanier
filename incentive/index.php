...
<!--             <h1>HELLO <span>THERE</span></h1> -->
            <br>
            <h2><i>Hello there</i>, If you are on this page it means you are interested in our offer.</h2>
...
<h2 style="color:#ffe81c;">Click the link below to get started now!!!</h2><br>
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="../assets/img/undraw_agreement_re_d4dv.svg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
