...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>HFSecrets</span></a></h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            ...
            <br>
            <h2>Forex or (FX) means foreign exchange. It is the global electronic marketplace for trading international currencies and currency derivatives. It has no central physical location, yet the forex market is the largest, most liquid market in the world by trading volume, with trillions of dollars changing hands every day. Most of the trading is done through banks, brokers, and financial institutions. In the layman's term, forex is similar to buying and selling. In our everyday life, we perform trading unknown to some of us. e.g when you buy an item and exchange with a curency, exchange is done there. So in the case of forex, we are exchanging one country's currency for another. e.g EUR and USD.

The forex market is open 24 hours a day, five days a week, except for holidays. The forex market is open on many holidays on which stock markets are closed, though the trading volume may be lower. No doubt the forex market has made a lot of persons millionaires and billionaires. We at .... are providing an opportunity for interested person to trade the financial markets and make money from it.</h2> 
