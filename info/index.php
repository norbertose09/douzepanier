      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>NEW TO <span>FOREX TRADE?</span></h1>
            <br>
...
The forex market is open 24 hours a day, five days a week, except for holidays. Also, the forex market is open on many holidays on which stock markets are closed, although the trading volume may be lower. The forex market has Undoubtedly made a lot of persons millionaires and even billionaires. We at 12 Baskets Financial Solutions are creating opportunities to learn, trade and leverage the financial markets with the aim of achieving your financial freedom.</h2> 
<h1>Click the link below to see our offers</h1><br>
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="../assets/img/undraw_Business_plan_re_0v81.png" class="img-fluid animated" alt="">
        </div><br><br>
      </div>
    </div>
